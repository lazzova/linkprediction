...
public class LinkpredProblem {
	...
	public void optimize () {
		NonLinearConjugateGradientOptimizer opt = new NonLinearConjugateGradientOptimizer(
				...
				new SimplePointChecker<PointValuePair>(1.0e-5, 1.0e-3, 100));                           // create optimizer using Polak-Ribiere formula, and convergence 
		                                                                                                // after 10^-5 difference between iterations, or 10^-3 cost function, 
		...
		MultiStartMultivariateOptimizer optimizer = 
				new MultiStartMultivariateOptimizer(opt, 10, rvg);                                       // creates multistart optimizer with 10 starting points
