...
public class DorogovtsevMendesGraphGenerator extends GraphGenerator {
	/**Random number generator*/
	private JDKRandomGenerator rand;
	private static int id = 0;
	private Generator generator;
	
	public DorogovtsevMendesGraphGenerator() {
		super();
	...
	public RandomWalkGraph generate(int n, int f, int s) {
		...
		generator.begin();
		for (int i = 0; i < n-3; i++)       // n-3 because i think it starts with a triangle
